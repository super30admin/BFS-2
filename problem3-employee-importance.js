...
GetImportance = function(employees, id) {
  var front, hash, output, queue;
  hash = new Map();
  employees.forEach(function({id, importance, subordinates}) {
  ...
  while (queue.length > 0) {
    ...
    hash.get(front).subordinates.forEach(function(sub) {
...
//# sourceMappingURL=problem3-employee-importance.js.map
